...
const routes: Routes = [
  ...
  {
    path: 'add-digital-sign',
    loadChildren: () => import('./add-digital-sign/add-digital-sign.module').then(m => m.AddDigitalSignPageModule)
  },
 
  {
    path: 'digital-sign-modal',
    loadChildren: () => import('./digital-sign-modal/digital-sign-modal.module').then( m => m.DigitalSignModalPageModule)
  },  {
    path: 'video-call-modal',
    loadChildren: () => import('./video-call-modal/video-call-modal.module').then( m => m.VideoCallModalPageModule)
  },
