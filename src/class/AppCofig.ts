export class AppConfig {
  // url: string = 'http://localhost:44346/api';
  ...
  //   https://adrapi.peacegate.in/api

  // jizel links added 
  // url:string=' https://adrapi.peacegate.in/api';
  //   AssetUrl:string=' https://adrapi.peacegate.in/api';
  // AdrDashboard='https://adr.peacegate.in/dashboard/';
  // imagelink:string = 'https://adr.peacegate.in/';
  //   videocalllayoutlink:string = 'https://adr.peacegate.in/dashboard/';

  // Link:string='https://peacegate.in';
  // AdminAssets="https://admin.peacegate.in"
  //     AdminpgURL="https://admin.peacegate.in/api"

  // jizel links added   X

  url: string = 'https://adrapi.initstore.com/api';
 AssetUrlAdmin:string='https://pgadmin.initstore.com'
  ...
  AppVersion: string = '1.0.86'; //1.0.79 initstore // live 1.0.0
  ...
  // to get location
  geocodeUrl: string = 'https://nominatim.openstreetmap.org/reverse';
